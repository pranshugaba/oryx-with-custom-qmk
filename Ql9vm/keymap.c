...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_W,           KC_E,           KC_R,           KC_T,                                           KC_Y,           KC_U,           KC_I,           KC_O,           KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_Q,           KC_X,           KC_M,           KC_C,           KC_V,                                           KC_K,           KC_P,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_NO,          
                                                    KC_SPACE,       MO(4),                                          MO(5),          KC_LEFT_SHIFT
  ),
  [2] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    ...
    KC_TRANSPARENT, KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_NO,          
                                                    KC_SPACE,       MO(4),                                          MO(5),          KC_LEFT_SHIFT
  ),
  [3] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
  ...
  [6] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_NO,          KC_F9,          KC_F8,          KC_F7,          KC_F12,                                         KC_MINUS,       KC_7,           KC_8,           KC_9,           KC_NO,          KC_NO,          
    KC_TRANSPARENT, KC_NO,          KC_F6,          KC_F5,          KC_F4,          KC_F11,                                         KC_DOT,         KC_4,           KC_5,           KC_6,           KC_NO,          KC_NO,          
    KC_TRANSPARENT, KC_NO,          KC_F3,          KC_F2,          KC_F1,          KC_F10,                                         KC_0,           KC_1,           KC_2,           KC_3,           KC_NO,          KC_NO,          
